...
public class RGBledCAN extends Subsystem {
    ...
    public void LEDred() {
    	LEDcontroller.setLEDOutput(1.0, LEDChannel.LEDChannelB);
    }
    
    public void LEDgreen() {
    	LEDcontroller.setLEDOutput(1.0, LEDChannel.LEDChannelC);
    }
    
    public void LEDblue() {
    	LEDcontroller.setLEDOutput(1.0, LEDChannel.LEDChannelA);
    }
