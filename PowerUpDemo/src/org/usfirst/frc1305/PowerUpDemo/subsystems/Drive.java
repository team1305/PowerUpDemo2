...
//	driveRight4.configSelectedFeedbackSensor(FeedbackDevice.QuadEncoder, 0, 0);
	   
	   driveLeft1.configNeutralDeadband(0.05, 0);
	   driveRight4.configNeutralDeadband(0.05, 0);
	...
	///driveLeft1.configNeutralDeadband(0.001, 0);
   	 	
	Left_wheel_encoder = new Encoder(2, 3, true);
	Right_wheel_encoder = new Encoder(0, 1, false);
	
    double circumferenceOfWheel = 4*Math.PI;
    ...
    Left_wheel_encoder.setDistancePerPulse(GearRatio * circumferenceOfWheel * driveCorrectionMultiplier / pulsesPerRevolution);
    Right_wheel_encoder.setDistancePerPulse(GearRatio * circumferenceOfWheel * driveCorrectionMultiplier  / pulsesPerRevolution);
    //Left_wheel_encoder.setDistancePerPulse(GearRatio * circumferenceOfWheel / pulsesPerRevolution);
    //Right_wheel_encoder.setDistancePerPulse(GearRatio * circumferenceOfWheel / pulsesPerRevolution);

	//Left_wheel_encoder.setReverseDirection(true);
	//Right_wheel_encoder.setReverseDirection(true);

//	Left_wheel_encoder.setDistancePerPulse(-1);
//	Right_wheel_encoder.setDistancePerPulse(1);
    ...
    public void DriveWithJoyStick(Joystick stick) {
    	...
    	///this ones best//// robotdrive.curvatureDrive(xSpeed, zRotation, true);  //isQuickTurn - If set, overrides constant-curvature turning for turn-in-place maneuvers.

//    	double deadbandspeed = 0.05;
//    	double deadbandrotation = 0.05;
//    
//    	if  (Math.abs(xSpeed) > deadbandspeed); 
//    		robotdrive.curvatureDrive(xSpeed, zRotation, true);  //isQuickTurn - If set, overrides constant-curvature turning for turn-in-place maneuvers.
//    	
//    	if  (Math.abs(zRotation) > deadbandrotation); 
//    		robotdrive.curvatureDrive(xSpeed, zRotation, true);  //isQuickTurn - If set, overrides constant-curvature turning for turn-in-place maneuvers.
