...
*/
        ...
        autonomousModes.addDefault("Scale   Sec: Cube Pickup",new AutoCommands(1));
        autonomousModes.addObject("Scale   Sec: Preset Location",new AutoCommands(2));
        autonomousModes.addObject("Switch   Sec: Cube Pickup",new AutoCommands(3));
