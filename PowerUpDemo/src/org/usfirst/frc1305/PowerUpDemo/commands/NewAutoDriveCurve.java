 ...
 *
 */
public class NewAutoDriveCurve extends Command {
    ...
    public NewAutoDriveCurve(double angle, double distance,  double power, double minpower, double rampup, double rampdown) {
