 ...
 *
 */
public class ZZZ_NewAutoDriveReverse extends Command {
    ...
    public ZZZ_NewAutoDriveReverse(double angle, double distance,  double power, double minpower,double rampup, double rampdown) {
    ...
    protected void execute() {
    	...
    	double dif = angle - Robot.navX.getYaw();
