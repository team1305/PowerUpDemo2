 ...
 *
 */
public class ZZZ_NewAutoDriveStraight extends Command {
    ...
    public ZZZ_NewAutoDriveStraight(double angle1, double distance1, double angle2, double distance2,  double power, double minpower, double rampup ) {
...
//    		speedright = Math.min(speedright, power);
    	...
    	//	double RampDownPercent =  (( distance - currPos ) / RampDownDist) ;
        	...
        	double dif2 = NewAngleTarget - Robot.navX.getYaw();
